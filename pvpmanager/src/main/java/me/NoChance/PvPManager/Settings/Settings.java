...
public final class Settings {
	...
	public static void initizalizeVariables(final YamlConfiguration c) {
		...
		windChargeRenewTag = MCVersion.isHigherThan(MCVersion.V1_20_5) && combatTagSection.getBoolean("WindCharge.Renew Tag", true);
		...
		blockUnsafeTeleports = combatTagSection.getBoolean("Block.Unsafe Teleports", false);
		...
		blockGlideInCombat = combatTagSection.getBoolean("Block.Elytra.Block Gliding", false);
		blockFireworksInCombat = combatTagSection.getBoolean("Block.Elytra.Block Fireworks", false);
		fireworkPowerLimit = combatTagSection.getInt("Block.Elytra.Firework Power Limit", -1);
